...
import com.github.milomarten.fracktail.core.dice.*;
...
import static com.github.milomarten.fracktail.core.dice.Utils.doNTimes;
...
public class FixedDiceExpression<E> extends AbstractDiceExpression<E> {
    ...
    Rollable<E> die;
    @Builder.Default
    DiceTotalingStrategy<E> totalingStrategy = new BasicTotalingStrategy<>();
